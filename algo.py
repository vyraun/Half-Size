...
Glove = {}
f = open('./GloVe/glove.6B.50d.txt', 'r', encoding="utf-8")
...
embedding_file = open('pca_embed2.txt', 'w', encoding="utf-8")
...
print((subprocess.check_output(["python", "all_wordsim.py", "pca_embed2.txt", "data/word-sim/"])).decode("utf-8"))
print("Results for Glove")
print((subprocess.check_output(["python", "all_wordsim.py", "./GloVe/glove.6B.50d.txt", "data/word-sim/"])).decode("utf-8"))